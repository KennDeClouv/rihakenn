<section class="footer">
    <div class="header-stroke is-footer">
        <div class="header-stroke_wrap">
            <div class="w-embed"><svg width="1444" height="81" viewbox="0 0 1444 81" fill="none"
                    xmlns="http://www.w3.org/2000/svg" style="width:100%; height:100%;" preserveaspectratio="none">
                    <path d="M1444 16.216C777.229 -13.1527 203.512 3.97903 0 16.216V81H1444V16.216Z" fill="#2C2C2C">
                    </path>
                </svg></div>
        </div>
    </div>
    <div data-w-id="f6b43ffe-7d6f-b42d-6e11-ec3c336e4408" class="footer_content">
        <div class="padding-global">
            <div class="w-layout-blockcontainer container-col-12 w-container">
                <div class="footer-content">
                    <div class="footer-header">
                        <div class="w-layout-blockcontainer max-width-col-10 w-container">
                            <div class="footer-heading_wrapper">
                                <div class="max-width-col-08">
                                </div>
                            </div>
                        </div>
                    </div>
